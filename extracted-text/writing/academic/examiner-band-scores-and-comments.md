...
performance at the 9 IELTS bands. These             This criterion refers to the range of
descriptors apply to both the Academic and          vocabulary the candidate has used and the
General Training Modules.                           accuracy and appropriacy of that use in
                                                    terms of the specific task.

Task 1 responses are assessed on the                Grammatical Range and Accuracy
following criteria:                                 This criterion refers to the range and
• Task Achievement                                  accurate use of the candidate’s
...
• Task Response                                     formulate and develop a position in relation
                                                    to a given prompt in the form of a question
• Coherence and Cohesion                            or statement, using a minimum of 250
• Lexical Resource                                  words. Ideas should be supported by
...
Task 1                                              Writing responses are marked by trained and
...
response fulfils the requirements set out in        Below you will find candidates’ responses to
the task, using the minimum of 150 words.           the two tasks in the sample Academic Writing
...
other visual input, not to speculative              The examiners’ guidelines for marking the
explanations that lie outside the given data.       Writing scripts are very detailed. There
Coherence and Cohesion                              are many different ways a candidate may
                                                    achieve a particular band score. The
This criterion is concerned with the overall        candidates’ answers that follow should
organisation and logical development of the         not be regarded as definitive examples of
message: how the response organises and             any particular band score.
links information, ideas and language.
                                                    Please refer to the publicly available
Coherence refers to the linking of ideas through    IELTS Writing Key Criteria on our website.
